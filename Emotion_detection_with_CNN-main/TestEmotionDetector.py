...
while True:
    ...
    if not ret:
        break
    face_detector = cv2.CascadeClassifier('C:/Users/Natanya Modi/OneDrive/Desktop/Projects/attention-span-detection/Emotion_detection_with_CNN-main/haarcascades/haarcascade_frontalface_default.xml')
